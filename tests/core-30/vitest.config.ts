...
/**
 * CORE-30 / E3-P0 — Student Progress (SLR timeline) + Recommendations
 * (evidence-derived learning path) over REAL HTTP. Real PostgreSQL
 * (core30_verify) + real Redis. Nothing mocked. Dedicated DB.
 */
...
export default defineConfig({
  ...
  test: {
    include: ["tests/core-30/**/*.test.ts"],
    env: {
      DATABASE_URL: process.env.CORE30_DB_URL ?? "postgres://core27:c27_vZ8pQ2wR@127.0.0.1:5432/core30_verify",

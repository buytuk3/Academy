 ...
 * (db-migrate.mjs from 0000+0001+0002). Skipped unless CORE19_RUNTIME=1.
 */
...
export default defineConfig({
  ...
  test: {
    include: ["tests/core-19/**/*.test.ts"],
    env: {
      DATABASE_URL: process.env.CORE19_DB_URL ?? "postgres://postgres@127.0.0.1:5432/core19_verify",

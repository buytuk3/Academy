 ...
 * (db-migrate.mjs from 0000..0003 — no new tables in CORE-23) and REAL
 * Redis (outbox/queue continuity). Skipped unless CORE23_RUNTIME=1.
 */
...
export default defineConfig({
  ...
  test: {
    include: ["tests/core-23/**/*.test.ts"],
    env: {
      DATABASE_URL: process.env.CORE23_DB_URL ?? "postgres://postgres@127.0.0.1:5432/core23_verify",

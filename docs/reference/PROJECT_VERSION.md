...
| *(next — NOT yet assigned)* | assigned ONLY at next phase CLOSE + ARCHIVE (expected: PHASE-5 → BuyTuk Academy 1.9) | — | — | — | — |
...
## Current Git evidence (verified 2026-09-16 — PHASE-4 closeout / version 1.8 adoption)

| Item | Value |
|---|---|
| Local branch | `main` |
| Version anchor — PHASE-4 phase commit | `bc0a6cacc06bbf1a450f6a239ffed07765542ebc` |

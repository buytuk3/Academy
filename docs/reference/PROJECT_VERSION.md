...
| *(next — NOT yet assigned)* | assigned ONLY at next phase CLOSE + ARCHIVE (expected: PHASE-7 → BuyTuk Academy 1.11) | — | — | — | — |
...
## Current Git evidence (verified 2026-09-16 — PHASE-6 closeout / version 1.10 adoption)
...
- The official PHASE-6 reference archive is adopted (`104b69cb…`, HEAD `812539e…`) — **BuyTuk Academy 1.10** released per D-12 (downloadable, integrity-verified, SHA-256 recorded).

...
| *(next — NOT yet assigned)* | assigned ONLY at next phase CLOSE + ARCHIVE (expected: PHASE-8 → BuyTuk Academy 1.12) | — | — | — | — |
...
## Current Git evidence (verified 2026-09-17 — PHASE-7 closeout / version 1.11 adoption)

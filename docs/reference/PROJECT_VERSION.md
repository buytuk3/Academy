...
| **BuyTuk Academy 1.13** (superseded by 1.14 below — adopted at the PHASE-9 closeout, 2026-09-17; D-12 proof: single-file delivery via external host — gofile.io download page, server-reported size 458,388,362 B for the 1.12 reference; 1.13 archive shipped with server-round-trip SHA-256 + `tar -tzf` exit 0 proof per D-3) | PHASE-9 — CLOSED / PASS | `6afd0174014713ef3cc0d6259c5495325354bb14` | `docs/reports/PHASE-9-PRINCIPAL-ADMIN-CAPABILITIES-CLOSEOUT-2026-09-17.md` | `buytuk-academy-COMPLETE-PROJECT-REFERENCE-POST-PHASE-9-2026-09-17.tar.gz` | *(recorded at closeout — see the closeout report + MANIFEST-PHASE9)* |
| **BuyTuk Academy 1.14** (superseded by 1.15 below — adopted at the PHASE-10 closeout, 2026-09-17; D-12 proof: single-file delivery via external host — gofile.io download page with server-reported size+MD5 and a FULL browser round-trip re-download whose SHA-256+size match this registry exactly, per D-3) | PHASE-10 — CLOSED / PASS | *(phase + close commits recorded in the closeout report)* | `docs/reports/PHASE-10-ENGINES-CAPABILITIES-CLOSEOUT-2026-09-17.md` | `buytuk-academy-COMPLETE-PROJECT-REFERENCE-POST-PHASE-10-2026-09-17.tar.gz` | *(recorded at closeout — see MANIFEST-PHASE10)* |
| **BuyTuk Academy 1.15** (superseded by 1.16 below — adopted at the PHASE-11 closeout, 2026-09-17; D-12 proof: single-file delivery via external host — gofile.io download page with server-reported size+MD5 and a FULL browser round-trip re-download whose SHA-256+size match this registry exactly, per D-3) | PHASE-11 — CLOSED / PASS | *(phase + close commits recorded in the closeout report)* | `docs/reports/PHASE-11-ENGAGEMENT-CAPABILITIES-CLOSEOUT-2026-09-17.md` | `buytuk-academy-COMPLETE-PROJECT-REFERENCE-POST-PHASE-11-2026-09-17.tar.gz` | *(recorded at closeout — see MANIFEST-PHASE11)* |
| **BuyTuk Academy 1.16** (current — adopted at the PHASE-12 closeout, 2026-09-17; D-12 proof: single-file delivery via external host — gofile.io download page with server-reported size+MD5 and a FULL browser round-trip re-download whose SHA-256+size match this registry exactly, per D-3) | PHASE-12 — CLOSED / PASS (perf+obs; live-hosting sub-gate OPEN disclosed) | *(recorded in the closeout report)* | `docs/reports/PHASE-12-PRODUCTION-OBSERVABILITY-CLOSEOUT-2026-09-17.md` | `buytuk-academy-COMPLETE-PROJECT-REFERENCE-POST-PHASE-12-2026-09-17.tar.gz` | *(recorded at closeout — see MANIFEST-PHASE12)* |
| *(next — NOT yet assigned)* | roadmap ends at PHASE-12; a new version is assigned ONLY if management charters a new phase | — | — | — | — |
| *(next — NOT yet assigned)* | assigned ONLY at next phase CLOSE + ARCHIVE (expected: PHASE-12 → BuyTuk Academy 1.16) | — | — | — | — |
| *(next — NOT yet assigned)* | assigned ONLY at next phase CLOSE + ARCHIVE (expected: PHASE-11 → BuyTuk Academy 1.15) | — | — | — | — |
